 ...
 */
@WebServlet("/score-input1.do")
public class ScoreInputServletByHiddenParameter extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ScoreInputServletByHiddenParameter() {
        super();
...
//			countCookie = new Cookie("count", "0");
		...
		Cookie countCookie = findCookie(cookies, "count");
		int count = (countCookie == null) ? 
				0 : Integer.parseInt(countCookie.getValue());
